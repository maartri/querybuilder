...
export class QueryBuilderComponent implements OnInit, OnChanges, ControlValueAccessor, Validator {
  ...
  @Input() data: RuleSet = { condition: 'and', dataType: 'AccountConfig', rules: [] };

  // For ControlValueAccessor interface
  public onChangeCallback: () => void;
  public onTouchedCallback: () => any;

  @Input() dataTypeArr: Array<string> = [];
  ...
  @Output() emitDataType = new EventEmitter();
  ...
  set value(value: RuleSet) {
    ...
    console.log(value)
    this.data = value || { condition: 'and', dataType: 'AccountConfig', rules: [] };
  ...
  addRuleSet(parent?: RuleSet): void {
    ...
    this.dataTypeArr = ['AccountConfig','InvoiceRule']   
    // console.log(parent);
    // console.log(this.config.addRuleSet)
    parent = parent || this.data;
